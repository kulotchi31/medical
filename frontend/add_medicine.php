    ...
    <div class="container mt-5">
        ...
        <div class="card shadow">
            ...
            <div class="card-header py-3">
                <h3 class="m-0 font-weight-bold text-primary">Create New Medicine</h3>
            </div>
            <div class="card-body">
                <form action="../backend/register_medicine.php" method="POST" onsubmit="return confirmSubmission();">
                    <div class="form-group">
                        <label for="email">Medicine Name</label>
                        <input type="text" name="medicineName" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label for="first_name">Medicine Description</label>
                        <input type="text" name="medicineDescription" class="form-control" required>
                    </div>
