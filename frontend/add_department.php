    ...
    <div class="container mt-5">
        ...
        <div class="card shadow">
            ...
            <div class="card-header py-3">
                <h3 class="m-0 font-weight-bold text-primary">Create New Department</h3>
            </div>
            <div class="card-body">
                <form action="../backend/register_department.php" method="POST" onsubmit="return confirmSubmission();">
